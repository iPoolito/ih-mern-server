...
exports.createPet = async (req, res) => {
  ...
  const { name, pictureUrl, age, gender, isVaccinated, description } = req.body
...
exports.updatePet = async (req, res) => {
  const { id, name, pictureUrl, age, gender, isVaccinated, description, availableForAdoption } = req.body
